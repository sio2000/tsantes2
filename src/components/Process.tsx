...
const steps = [
  {
    ...
    icon: MessageCircle,
    title: 'Επιλέγεις',
    desc: 'Επιλέγεις την κατηγορία — sneakers, τσάντα ή πλήρες custom. Κάνεις το πρώτο βήμα προς κάτι μοναδικό.',
  },
  {
    number: '02',
    icon: Lightbulb,
    title: 'Μοιράζεσαι την ιδέα',
    desc: 'Μας λες την ιδέα σου — χρώματα, στυλ, εμπνεύσεις. Όσο πιο αναλυτικά, τόσο πιο κοντά στο όραμά σου.',
  },
  {
    number: '03',
    icon: PenTool,
    title: 'Σχεδιάζουμε',
    desc: 'Δημιουργούμε ένα προσχέδιο βασισμένο στην ιδέα σου. Ακούμε, επανεξετάζουμε, τελειοποιούμε.',
  },
  {
    number: '04',
    icon: Hammer,
    title: 'Δημιουργούμε',
    desc: 'Ξεκινά η χειροποίητη κατασκευή. Κάθε λεπτομέρεια φτιάχνεται με πάθος, precision και αφοσίωση.',
  },
  {
    number: '05',
    icon: Package,
    title: 'Παραδίδουμε',
    desc: 'Το μοναδικό σου κομμάτι φτάνει στα χέρια σου, συσκευασμένο με την ανάλογη προσοχή.',
  },
];
      ...
      <div className="px-6 md:px-12 lg:px-20 max-w-7xl mx-auto pt-16 md:pt-24">
        <div className="text-center mb-16 md:mb-20">
          <div className="reveal mb-4">
            <span className="section-tag">Η Διαδικασία</span>
          </div>
          <h2
          ...
          >
            Από την ιδέα
            <br />
            <em style={{ fontStyle: 'italic' }} className="gold-gradient">στα χέρια σου</em>
          </h2>
          <p
          ...
          >
            Κάθε δημιουργία ακολουθεί μια διαδικασία που σέβεται τον χρόνο,
            την τέχνη και σένα.
          </p>
        </div>
